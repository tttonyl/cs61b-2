...
public class SList {
  ...
  public void insertFront(Object obj) {
    head = new SListNode(obj, head); // create new node that points to the previous head. Update head to be the new obj
    size++;
  ...
  public String toString() { // create new node that points to the previous head. Update head to be the new obj
    int i;
    Object obj;
    String result = "[  ";
   ...
   *         and print the resulting list.
   */
  private static void labPartOne() {
    SList zachList = new SList();
    zachList.insertEnd(6);
    zachList.insertEnd(9);
    zachList.insertEnd(12);
    System.out.println(zachList);

    zachList.insertEnd(15);
    zachList.insertFront(3);
    System.out.println(zachList);
  }
